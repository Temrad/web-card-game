...
public class UpgradeDaoImpl implements UpgradeDao {
    ...
    public List<UpgradeEntity> getAllUpgradeList() {
        return SqlHelper.prepareStatement(GET_ALL, query -> {
                ...
                upgradeEntities.add(new UpgradeEntity() {
                    {
                        ...
                        setResourceSetList(fillResourceSetEntityList(resultSet));
                        setBuildingSetList(fillBuildingSetEntityList(resultSet));
                    }
                });
            }
    ...
    private List<BuildingSetEntity> fillBuildingSetEntityList(ResultSet resultSet) throws SQLException {
    ...
    private List<ResourceSetEntity> fillResourceSetEntityList(ResultSet resultSet) throws SQLException {
